      ...
      <div className="pt-40">
        <div className="max-w-[80%] py-5 mx-auto flex items-center">
          ...
          <div className="w-[40%] p-5 text-center">
            <h4 className="text-[#dc5a6b] text-4xl capitalize font-medium ">
              fresh juice shop
            </h4>
            <h3 className="text-[55px] font-medium text-white">summer juice</h3>
            <div className="flex justify-center items-center gap-2">
              <span className="text-4xl text-white">.</span>
              <span className="text-4xl">.</span>
              <span className="text-4xl text-white">.</span>
            </div>
            <p className="text-[16px] font-medium py-2 text-white">
