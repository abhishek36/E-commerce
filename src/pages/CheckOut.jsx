...
const CheckOut = () => {
  ...
  return (
    <div className="mt-[150px] border md:flex md:flex-row flex flex-col-reverse md:gap-0 gap-3 md:max-w-[80%] max-w-[90%] mx-auto">
      <div className="left md:w-[60%] w-full border p-3">
        <div>
        ...
        <div className="mt-10">
          ...
          <div className="bg-gray-200 p-5">
            <h3 className="text-xl capitalize font-medium my-1">credit card</h3>
            <input
              type="number"
